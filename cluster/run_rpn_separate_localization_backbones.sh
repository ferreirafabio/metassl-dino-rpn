#!/bin/zsh
#SBATCH -p mldlc_gpu-rtx2080 #bosch_gpu-rtx2080 #alldlc_gpu-rtx2080
#SBATCH --gres=gpu:8
#SBATCH -J dino_rpn_rts_bounded_no_warmup_sep_loc_head
#SBATCH -t 4-23:59:59 #23:59:59
#SBATCH --array 0-30%1
